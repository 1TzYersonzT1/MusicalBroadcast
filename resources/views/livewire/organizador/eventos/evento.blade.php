<div class="swiper-slide">
    <div class="lg:w-96 w-80 bg-white text-primary py-3 px-5">
        <div class="flex justify-between items-center">
            ...
            @if ($evento->solicitudes[0]->estado == 1)
                <div class="bg-pink-400 rounded-full w-32 py-1 text-center"><span
                        class="text-purple-600">Revisada</span>
                </div>
            @endif

            @if ($evento->solicitudes[0]->estado == 4)
        ...
        <div class="mt-3">
            <div>
                ...
                <p class="font-light">{{ $evento->solicitudes[0]->observacion }}
                </p>
            </div>
        </div>
        <button
            ...
            <a href="{{ route('organizador.modificar-evento', $evento->id) }}">
                Modificar
            </a>
