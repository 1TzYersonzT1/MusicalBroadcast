<div class="min-h-screen gap-5 text-white py-4 flex-col">
    <div class="col-span-8">
        <div class="col-span-8 text-center">
            ...
            <div class="mt-5">
                <button id="confirmarNombre"
                    class="bg-white text-primary py-5 px-5 rounded-full">Continuar</button>
            </div>
        </div>
